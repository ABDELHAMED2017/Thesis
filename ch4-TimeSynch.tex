...
\todo[inline]{The needed computation of proposed architecture compared to the full cross-correlation techniques is minimised by not only taking advantage of the periodic nature of preamble. 
It should be noted that profiting from the real number computation of proposed metrics instead of complex numbers, and from using multiplierless correlator that also obtains a significant computational cost.}
