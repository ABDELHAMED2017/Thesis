...
It should be noted that profiting from the real number computation of proposed metrics instead of complex numbers, and from using multiplierless correlator also obtain a significant computational cost.}
