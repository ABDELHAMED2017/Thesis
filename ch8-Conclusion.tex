...
%This work explores the advantages of coupling PR and parameterised functional units in one architecture to offer
%flexibility for OFDM-based baseband processing
